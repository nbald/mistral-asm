#!/usr/bin/env python3
"""External oracle for the token-0 first FFN RMSNorm smoke.
...
path through the post-attention residual, then applies blk.0.ffn_norm.weight
with the same RMSNorm helper semantics used by the runtime smoke.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Print external token0 FFN RMSNorm oracle words.")
