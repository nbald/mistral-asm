...
# status line without exposing an output slice yet.
...
# otherwise status is 0 and no layer-2 FFN down payload bytes are read. Output
# write errors are diagnostic-only and are not surfaced separately.
