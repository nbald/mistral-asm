...
.equ TOKEN0_LAYER5_ATTN_V_OUTPUT_BYTES, TOKEN0_LAYER5_ATTN_V_OUTPUT_VALUES * 4

.section .rodata

token0_layer5_attn_norm_text:
	.ascii "token0_layer5_attn_norm: "
token0_layer5_attn_norm_text_end:
...
token0_layer5_attn_v_matvec_text:
	.ascii "token0_layer5_attn_v_matvec: "
token0_layer5_attn_v_matvec_text_end:

token0_layer5_attn_norm0_f32_text:
	.ascii "token0_layer5_attn_norm0_f32_hex: "
token0_layer5_attn_norm0_f32_text_end:

token0_layer5_attn_norm1_f32_text:
	.ascii "token0_layer5_attn_norm1_f32_hex: "
token0_layer5_attn_norm1_f32_text_end:

token0_layer5_attn_norm2_f32_text:
	.ascii "token0_layer5_attn_norm2_f32_hex: "
token0_layer5_attn_norm2_f32_text_end:

token0_layer5_attn_norm3_f32_text:
...
token0_layer5_attn_k_output0_f32_text:
	.ascii "token0_layer5_attn_k_output0_f32_hex: "
token0_layer5_attn_k_output0_f32_text_end:

token0_layer5_attn_k_output1_f32_text:
	.ascii "token0_layer5_attn_k_output1_f32_hex: "
token0_layer5_attn_k_output1_f32_text_end:

token0_layer5_attn_k_output2_f32_text:
	.ascii "token0_layer5_attn_k_output2_f32_hex: "
token0_layer5_attn_k_output2_f32_text_end:

token0_layer5_attn_k_output3_f32_text:
	.ascii "token0_layer5_attn_k_output3_f32_hex: "
token0_layer5_attn_k_output3_f32_text_end:

token0_layer5_attn_v_output0_f32_text:
	.ascii "token0_layer5_attn_v_output0_f32_hex: "
token0_layer5_attn_v_output0_f32_text_end:

token0_layer5_attn_v_output1_f32_text:
	.ascii "token0_layer5_attn_v_output1_f32_hex: "
token0_layer5_attn_v_output1_f32_text_end:

token0_layer5_attn_v_output2_f32_text:
	.ascii "token0_layer5_attn_v_output2_f32_hex: "
token0_layer5_attn_v_output2_f32_text_end:

token0_layer5_attn_v_output3_f32_text:
	.ascii "token0_layer5_attn_v_output3_f32_hex: "
token0_layer5_attn_v_output3_f32_text_end:
...
.global token0_layer5_attn_norm_status
.balign 8
...
token0_layer5_attn_norm_activation:
	.skip TOKEN0_LAYER5_ATTN_NORM_BYTES

.global token0_layer5_attn_q_matvec_status
.balign 8
...
.global token0_layer5_attn_v_matvec_status
.balign 8
...
.global run_token0_layer5_attn_norm_status
.type run_token0_layer5_attn_norm_status, @function

# Contract: run the token-0 layer-5 attention RMSNorm smoke and publish its
...
# RMSNorm epsilon metadata, the retained blk.5.attn_norm.weight descriptor,
# token0_layer4_post_ffn_residual_status, and the exported
# token0_layer4_post_ffn_residual handoff buffer.
# Outputs: writes token0_layer5_attn_norm_status and, on success, fills private
# token0_layer5_attn_norm_activation storage. Always prints exactly one status
...
# Ownership/lifetime: borrows the model mmap and the exported layer-4 post-FFN
# residual only during this call; owns the layer-5 attention RMSNorm status and
...
# and layer-4 residual prerequisites prove a bounded RMSNorm can complete.
# Otherwise status is 0, no layer-5 attention norm payload bytes are read, and
# no activation words are printed. Output write failures are diagnostic-only.
run_token0_layer5_attn_norm_status:
	call token0_layer5_attn_norm_smoke
	mov qword ptr [rip + token0_layer5_attn_norm_status], rax

	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_norm_text]
	mov rdx, token0_layer5_attn_norm_text_end - token0_layer5_attn_norm_text
	call sys_write

	mov rdi, 1
	mov rsi, qword ptr [rip + token0_layer5_attn_norm_status]
	...
	call print_token0_layer5_attn_norm_slice
	ret

.size run_token0_layer5_attn_norm_status, . - run_token0_layer5_attn_norm_status

.global run_token0_layer5_attn_q_matvec_status
...
run_token0_layer5_attn_q_matvec_status:
	call token0_layer5_attn_q_matvec_smoke
	mov qword ptr [rip + token0_layer5_attn_q_matvec_status], rax

	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_q_matvec_text]
	mov rdx, token0_layer5_attn_q_matvec_text_end - token0_layer5_attn_q_matvec_text
	call sys_write

	mov rdi, 1
	mov rsi, qword ptr [rip + token0_layer5_attn_q_matvec_status]
	call write_u64_decimal
...
# Contract: run the token-0 layer-5 attention key matvec smoke and publish its
# status line plus the fixed exact-hex oracle slice on success.
# Inputs: no register inputs. Reads the live mapping handoff slots, the retained
...
run_token0_layer5_attn_k_matvec_status:
	...
	call print_token0_layer5_attn_k_output_slice
	ret

.size run_token0_layer5_attn_k_matvec_status, . - run_token0_layer5_attn_k_matvec_status

.global run_token0_layer5_attn_v_matvec_status
.type run_token0_layer5_attn_v_matvec_status, @function

# Contract: run the token-0 layer-5 attention value matvec smoke and publish
# its status line plus the fixed exact-hex oracle slice on success.
# Inputs: no register inputs. Reads the live mapping handoff slots, the retained
...
# Output write failures are diagnostic-only in the current milestone.
run_token0_layer5_attn_v_matvec_status:
	call token0_layer5_attn_v_matvec_smoke
	mov qword ptr [rip + token0_layer5_attn_v_matvec_status], rax

	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_v_matvec_text]
	mov rdx, token0_layer5_attn_v_matvec_text_end - token0_layer5_attn_v_matvec_text
	call sys_write

	mov rdi, 1
	mov rsi, qword ptr [rip + token0_layer5_attn_v_matvec_status]
	call write_u64_decimal
	...
	call print_token0_layer5_attn_v_output_slice
	ret

.size run_token0_layer5_attn_v_matvec_status, . - run_token0_layer5_attn_v_matvec_status
...
# Inputs: no register inputs. Reads token0_layer5_attn_norm_status and the
# first four f32 words of token0_layer5_attn_norm_activation.
# Outputs: writes four labeled raw f32 bit patterns to stdout when
# token0_layer5_attn_norm_status is 1; writes nothing otherwise.
# Clobbers: caller-saved registers and flags through sys_write and
# write_u32_hex.
# Ownership/lifetime: reads private module-owned layer-5 attention RMSNorm
...
print_token0_layer5_attn_norm_slice:
	cmp qword ptr [rip + token0_layer5_attn_norm_status], 1
	jne .Lprint_layer5_attn_norm_slice_done

	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_norm0_f32_text]
	mov rdx, token0_layer5_attn_norm0_f32_text_end - token0_layer5_attn_norm0_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_norm_activation]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_norm1_f32_text]
	mov rdx, token0_layer5_attn_norm1_f32_text_end - token0_layer5_attn_norm1_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_norm_activation + 4]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_norm2_f32_text]
	mov rdx, token0_layer5_attn_norm2_f32_text_end - token0_layer5_attn_norm2_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_norm_activation + 8]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_norm3_f32_text]
	mov rdx, token0_layer5_attn_norm3_f32_text_end - token0_layer5_attn_norm3_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_norm_activation + 12]
	call write_u32_hex
...
.Lprint_layer5_attn_norm_slice_done:
	ret
...
.type print_token0_layer5_attn_k_output_slice, @function

# Contract: print a fixed exact-hex slice from the token-0 layer-5 attention
# key projection when that smoke path succeeded.
# Inputs: no register inputs. Reads token0_layer5_attn_k_matvec_status and the
# first four f32 words of token0_layer5_attn_k_output.
# Outputs: writes four labeled raw f32 bit patterns to stdout when
...
# Error behavior: this is summary output for oracle comparison; write failures
# are intentionally not surfaced separately.
print_token0_layer5_attn_k_output_slice:
	cmp qword ptr [rip + token0_layer5_attn_k_matvec_status], 1
	jne .Lprint_layer5_attn_k_output_slice_done

	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_k_output0_f32_text]
	mov rdx, token0_layer5_attn_k_output0_f32_text_end - token0_layer5_attn_k_output0_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_k_output]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_k_output1_f32_text]
	mov rdx, token0_layer5_attn_k_output1_f32_text_end - token0_layer5_attn_k_output1_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_k_output + 4]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_k_output2_f32_text]
	mov rdx, token0_layer5_attn_k_output2_f32_text_end - token0_layer5_attn_k_output2_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_k_output + 8]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_k_output3_f32_text]
	mov rdx, token0_layer5_attn_k_output3_f32_text_end - token0_layer5_attn_k_output3_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_k_output + 12]
	call write_u32_hex
...
.Lprint_layer5_attn_k_output_slice_done:
	ret

.size print_token0_layer5_attn_k_output_slice, . - print_token0_layer5_attn_k_output_slice

.type print_token0_layer5_attn_v_output_slice, @function

# Contract: print a fixed exact-hex slice from the token-0 layer-5 attention
# value projection when that smoke path succeeded.
# Inputs: no register inputs. Reads token0_layer5_attn_v_matvec_status and the
# first four f32 words of token0_layer5_attn_v_output.
# Outputs: writes four labeled raw f32 bit patterns to stdout when
...
# Error behavior: this is summary output for oracle comparison; write failures
# are intentionally not surfaced separately.
print_token0_layer5_attn_v_output_slice:
	cmp qword ptr [rip + token0_layer5_attn_v_matvec_status], 1
	jne .Lprint_layer5_attn_v_output_slice_done

	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_v_output0_f32_text]
	mov rdx, token0_layer5_attn_v_output0_f32_text_end - token0_layer5_attn_v_output0_f32_text
	call sys_write
	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_v_output]
	call write_u32_hex
	mov rdi, 1
	lea rsi, [rip + newline_text]
	mov rdx, newline_text_end - newline_text
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_v_output1_f32_text]
	mov rdx, token0_layer5_attn_v_output1_f32_text_end - token0_layer5_attn_v_output1_f32_text
	call sys_write
	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_v_output + 4]
	call write_u32_hex
	mov rdi, 1
	lea rsi, [rip + newline_text]
	mov rdx, newline_text_end - newline_text
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_v_output2_f32_text]
	mov rdx, token0_layer5_attn_v_output2_f32_text_end - token0_layer5_attn_v_output2_f32_text
	call sys_write
	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_v_output + 8]
	call write_u32_hex
	mov rdi, 1
	lea rsi, [rip + newline_text]
	mov rdx, newline_text_end - newline_text
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer5_attn_v_output3_f32_text]
	mov rdx, token0_layer5_attn_v_output3_f32_text_end - token0_layer5_attn_v_output3_f32_text
	call sys_write
	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer5_attn_v_output + 12]
	call write_u32_hex
	mov rdi, 1
	lea rsi, [rip + newline_text]
	mov rdx, newline_text_end - newline_text
...
.Lprint_layer5_attn_v_output_slice_done:
	ret

.size print_token0_layer5_attn_v_output_slice, . - print_token0_layer5_attn_v_output_slice

.type token0_layer5_attn_norm_smoke, @function

# Contract: opportunistically apply the retained layer-5 attention RMSNorm
# weights to the token-0 layer-4 post-FFN residual activation.
# Inputs: no register inputs. Reads the process-owned layer5_attn_norm tensor
# slot, live mapping descriptor, retained RMSNorm epsilon metadata,
# token0_layer4_post_ffn_residual_status, and token0_layer4_post_ffn_residual.
# Outputs: rax = 1 when the layer-4 post-FFN residual is available, the epsilon
# metadata was captured, and blk.5.attn_norm.weight is exactly a
# one-dimensional f32 [3072] tensor whose full payload span fits inside the
# mapping, after rmsnorm_f32 writes token0_layer5_attn_norm_activation;
# otherwise rax = 0 and no layer-5 attention norm payload bytes are read.
...
# the exported layer-4 post-FFN residual through that helper, and writes exactly
# TOKEN0_LAYER5_ATTN_NORM_BYTES into private module storage on success. The
...
token0_layer5_attn_norm_smoke:
	xor eax, eax
	cmp qword ptr [rip + token0_layer4_post_ffn_residual_status], 1
	jne .Llayer5_attn_norm_smoke_done
	cmp qword ptr [rip + gguf_summary_attn_norm_rms_epsilon_found], 1
	jne .Llayer5_attn_norm_smoke_done
	cmp qword ptr [rip + layer5_attn_norm_tensor_found], 1
	jne .Llayer5_attn_norm_smoke_done
	cmp qword ptr [rip + layer5_attn_norm_tensor_n_dimensions], 1
	jne .Llayer5_attn_norm_smoke_done
	cmp qword ptr [rip + layer5_attn_norm_tensor_ggml_type], GGML_TYPE_F32
	jne .Llayer5_attn_norm_smoke_done
	cmp qword ptr [rip + layer5_attn_norm_tensor_dim0], TOKEN0_LAYER5_ATTN_NORM_VALUES
	jne .Llayer5_attn_norm_smoke_done
	...
	test rax, rax
	js .Llayer5_attn_norm_smoke_skip
	mov rdx, qword ptr [rip + layer5_attn_norm_tensor_offset]
	test rdx, rdx
	js .Llayer5_attn_norm_smoke_skip
	add rax, rdx
	jc .Llayer5_attn_norm_smoke_skip

	mov r10, qword ptr [rip + gguf_mapping_size]
	cmp rax, r10
	jae .Llayer5_attn_norm_smoke_skip

	mov r9, TOKEN0_LAYER5_ATTN_NORM_BYTES
	mov r11, r10
	sub r11, rax
	cmp r11, r9
	jb .Llayer5_attn_norm_smoke_skip

	mov rsi, qword ptr [rip + gguf_mapping_base]
	test rsi, rsi
	jz .Llayer5_attn_norm_smoke_skip
	add rsi, rax
	jc .Llayer5_attn_norm_smoke_skip

	lea rdi, [rip + token0_layer4_post_ffn_residual]
	lea rdx, [rip + token0_layer5_attn_norm_activation]
	mov rcx, TOKEN0_LAYER5_ATTN_NORM_VALUES
...
.Llayer5_attn_norm_smoke_skip:
	xor eax, eax

.Llayer5_attn_norm_smoke_done:
	ret

.size token0_layer5_attn_norm_smoke, . - token0_layer5_attn_norm_smoke

.type token0_layer5_attn_q_matvec_smoke, @function

# Contract: opportunistically project the token-0 layer-5
# attention-normalized activation through the retained blk.5.attn_q.weight
# matrix.
# Inputs: no register inputs. Reads the process-owned layer5_attn_q tensor slot,
...
# available and blk.5.attn_q.weight is exactly a two-dimensional Q8_0
# [3072 x 4096] matrix whose complete payload span fits inside the mapping,
# after q8_0_matvec_f32 writes token0_layer5_attn_q_output; otherwise rax = 0
# and no layer-5 query matrix payload bytes are read.
...
token0_layer5_attn_q_matvec_smoke:
	xor eax, eax
	cmp qword ptr [rip + token0_layer5_attn_norm_status], 1
	jne .Llayer5_attn_q_smoke_done
	...
	# layer-5 query matrix start and prove the complete row-major Q8_0 payload
	# fits inside the live mapping before passing any mmap pointer to math code.
	mov rax, qword ptr [rip + gguf_summary_tensor_data_offset]
	test rax, rax
	js .Llayer5_attn_q_smoke_skip
	mov rdx, qword ptr [rip + layer5_attn_q_tensor_offset]
	test rdx, rdx
	js .Llayer5_attn_q_smoke_skip
	add rax, rdx
	jc .Llayer5_attn_q_smoke_skip

	mov r10, qword ptr [rip + gguf_mapping_size]
	cmp rax, r10
	jae .Llayer5_attn_q_smoke_skip
	...
	jo .Llayer5_attn_q_smoke_skip
	mov rcx, TOKEN0_LAYER5_ATTN_Q_OUTPUT_VALUES
	mov rdx, rcx
	imul rdx, r11
	jo .Llayer5_attn_q_smoke_skip
	...
	sub r11, rax
	cmp r11, rdx
	jb .Llayer5_attn_q_smoke_skip

	mov rdi, qword ptr [rip + gguf_mapping_base]
	test rdi, rdi
	jz .Llayer5_attn_q_smoke_skip
	add rdi, rax
	jc .Llayer5_attn_q_smoke_skip

	lea rsi, [rip + token0_layer5_attn_norm_activation]
	lea rdx, [rip + token0_layer5_attn_q_output]
	mov r8, r9
...
.Llayer5_attn_q_smoke_skip:
	xor eax, eax

.Llayer5_attn_q_smoke_done:
	ret
...
.type token0_layer5_attn_v_matvec_smoke, @function

# Contract: opportunistically project the token-0 layer-5
# attention-normalized activation through the retained blk.5.attn_v.weight
# matrix.
# Inputs: no register inputs. Reads the process-owned layer5_attn_v tensor slot,
# live mapping descriptor, token0_layer5_attn_norm_status, and
# token0_layer5_attn_norm_activation.
# Outputs: rax = 1 when the layer-5 attention-normalized activation is
# available and blk.5.attn_v.weight is exactly a two-dimensional Q8_0
# [3072 x 1024] matrix whose complete payload span fits inside the mapping,
# after q8_0_matvec_f32 writes token0_layer5_attn_v_output; otherwise rax = 0
# and no layer-5 value matrix payload bytes are read.
# Clobbers: caller-saved registers, xmm0, xmm1, xmm2 and flags. The matvec
# helper preserves any callee-saved registers it uses internally.
# Ownership/lifetime: reads mapped Q8_0 matrix bytes only during
# q8_0_matvec_f32, reads the private layer-5 attention RMSNorm activation as
...
# projection, not final graph setup. Non-target synthetic GGUF fixtures and
# shape or bounds mismatches are skipped with status 0.
token0_layer5_attn_v_matvec_smoke:
	xor eax, eax
	cmp qword ptr [rip + token0_layer5_attn_norm_status], 1
	jne .Llayer5_attn_v_smoke_done
	...
	# Tensor offsets are relative to the aligned tensor-data base. Resolve the
	# layer-5 value matrix start and prove the complete row-major Q8_0 payload
	# fits inside the live mapping before passing any mmap pointer to math code.
	mov rax, qword ptr [rip + gguf_summary_tensor_data_offset]
	test rax, rax
	js .Llayer5_attn_v_smoke_skip
	mov rdx, qword ptr [rip + layer5_attn_v_tensor_offset]
	test rdx, rdx
	js .Llayer5_attn_v_smoke_skip
	add rax, rdx
	jc .Llayer5_attn_v_smoke_skip

	mov r10, qword ptr [rip + gguf_mapping_size]
	cmp rax, r10
	jae .Llayer5_attn_v_smoke_skip
	...
	mov r11, r9
	imul r11, r11, Q8_0_BLOCK_BYTES
	jo .Llayer5_attn_v_smoke_skip
	mov rcx, TOKEN0_LAYER5_ATTN_V_OUTPUT_VALUES
	mov rdx, rcx
	imul rdx, r11
	jo .Llayer5_attn_v_smoke_skip
	...
	sub r11, rax
	cmp r11, rdx
	jb .Llayer5_attn_v_smoke_skip

	mov rdi, qword ptr [rip + gguf_mapping_base]
	test rdi, rdi
	jz .Llayer5_attn_v_smoke_skip
	add rdi, rax
	jc .Llayer5_attn_v_smoke_skip

	lea rsi, [rip + token0_layer5_attn_norm_activation]
	lea rdx, [rip + token0_layer5_attn_v_output]
	mov r8, r9
	call q8_0_matvec_f32
...
.Llayer5_attn_v_smoke_skip:
	xor eax, eax

.Llayer5_attn_v_smoke_done:
	ret

.size token0_layer5_attn_v_matvec_smoke, . - token0_layer5_attn_v_matvec_smoke
