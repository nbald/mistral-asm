...
token0_layer4_post_ffn_residual0_f32_text:
	.ascii "token0_layer4_post_ffn_residual0_f32_hex: "
token0_layer4_post_ffn_residual0_f32_text_end:

token0_layer4_post_ffn_residual1_f32_text:
	.ascii "token0_layer4_post_ffn_residual1_f32_hex: "
token0_layer4_post_ffn_residual1_f32_text_end:

token0_layer4_post_ffn_residual2_f32_text:
	.ascii "token0_layer4_post_ffn_residual2_f32_hex: "
token0_layer4_post_ffn_residual2_f32_text_end:

token0_layer4_post_ffn_residual3_f32_text:
	.ascii "token0_layer4_post_ffn_residual3_f32_hex: "
token0_layer4_post_ffn_residual3_f32_text_end:
...
# Contract: run the token-0 layer-4 post-FFN residual smoke and publish its
# status line plus the fixed exact-hex oracle slice on success.
...
run_token0_layer4_post_ffn_residual_status:
	...
	call print_token0_layer4_post_ffn_residual_slice
	ret

.size run_token0_layer4_post_ffn_residual_status, . - run_token0_layer4_post_ffn_residual_status

.type print_token0_layer4_post_ffn_residual_slice, @function

# Contract: print a fixed exact-hex slice from the token-0 layer-4 post-FFN
# residual when that smoke path succeeded.
# Inputs: no register inputs. Reads token0_layer4_post_ffn_residual_status and
# the first four f32 words of token0_layer4_post_ffn_residual.
# Outputs: writes four labeled raw f32 bit patterns to stdout when
# token0_layer4_post_ffn_residual_status is 1; writes nothing otherwise.
# Clobbers: caller-saved registers and flags through sys_write and
# write_u32_hex.
# Ownership/lifetime: reads private module-owned layer-4 post-FFN residual
...
print_token0_layer4_post_ffn_residual_slice:
	cmp qword ptr [rip + token0_layer4_post_ffn_residual_status], 1
	jne .Lprint_layer4_post_ffn_residual_slice_done

	mov rdi, 1
	lea rsi, [rip + token0_layer4_post_ffn_residual0_f32_text]
	mov rdx, token0_layer4_post_ffn_residual0_f32_text_end - token0_layer4_post_ffn_residual0_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer4_post_ffn_residual]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer4_post_ffn_residual1_f32_text]
	mov rdx, token0_layer4_post_ffn_residual1_f32_text_end - token0_layer4_post_ffn_residual1_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer4_post_ffn_residual + 4]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer4_post_ffn_residual2_f32_text]
	mov rdx, token0_layer4_post_ffn_residual2_f32_text_end - token0_layer4_post_ffn_residual2_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer4_post_ffn_residual + 8]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer4_post_ffn_residual3_f32_text]
	mov rdx, token0_layer4_post_ffn_residual3_f32_text_end - token0_layer4_post_ffn_residual3_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer4_post_ffn_residual + 12]
	call write_u32_hex
...
.Lprint_layer4_post_ffn_residual_slice_done:
	ret

.size print_token0_layer4_post_ffn_residual_slice, . - print_token0_layer4_post_ffn_residual_slice
