...
token0_layer4_post_attn_residual0_f32_text:
	.ascii "token0_layer4_post_attn_residual0_f32_hex: "
token0_layer4_post_attn_residual0_f32_text_end:

token0_layer4_post_attn_residual1_f32_text:
	.ascii "token0_layer4_post_attn_residual1_f32_hex: "
token0_layer4_post_attn_residual1_f32_text_end:

token0_layer4_post_attn_residual2_f32_text:
	.ascii "token0_layer4_post_attn_residual2_f32_hex: "
token0_layer4_post_attn_residual2_f32_text_end:

token0_layer4_post_attn_residual3_f32_text:
	.ascii "token0_layer4_post_attn_residual3_f32_hex: "
token0_layer4_post_attn_residual3_f32_text_end:
...
run_token0_layer4_post_attn_residual_status:
	...
	call print_token0_layer4_post_attn_residual_slice
	ret
...
.type print_token0_layer4_post_attn_residual_slice, @function

# Contract: print a fixed exact-hex slice from the token-0 layer-4
...
# and the first four f32 words of token0_layer4_post_attn_residual.
# Outputs: writes four labeled raw f32 bit patterns to stdout when
# token0_layer4_post_attn_residual_status is 1; writes nothing otherwise.
# Clobbers: caller-saved registers and flags through sys_write and
# write_u32_hex.
# Ownership/lifetime: reads private module-owned layer-4 post-attention
...
print_token0_layer4_post_attn_residual_slice:
	cmp qword ptr [rip + token0_layer4_post_attn_residual_status], 1
	jne .Lprint_layer4_post_attn_residual_slice_done

	mov rdi, 1
	lea rsi, [rip + token0_layer4_post_attn_residual0_f32_text]
	mov rdx, token0_layer4_post_attn_residual0_f32_text_end - token0_layer4_post_attn_residual0_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer4_post_attn_residual]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer4_post_attn_residual1_f32_text]
	mov rdx, token0_layer4_post_attn_residual1_f32_text_end - token0_layer4_post_attn_residual1_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer4_post_attn_residual + 4]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer4_post_attn_residual2_f32_text]
	mov rdx, token0_layer4_post_attn_residual2_f32_text_end - token0_layer4_post_attn_residual2_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer4_post_attn_residual + 8]
	call write_u32_hex
	...
	mov rdi, 1
	lea rsi, [rip + token0_layer4_post_attn_residual3_f32_text]
	mov rdx, token0_layer4_post_attn_residual3_f32_text_end - token0_layer4_post_attn_residual3_f32_text
	call sys_write

	mov rdi, 1
	mov esi, dword ptr [rip + token0_layer4_post_attn_residual + 12]
	call write_u32_hex
...
.Lprint_layer4_post_attn_residual_slice_done:
	ret

.size print_token0_layer4_post_attn_residual_slice, . - print_token0_layer4_post_attn_residual_slice
